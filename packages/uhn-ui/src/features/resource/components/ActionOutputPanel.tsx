...
type ActionOutputPanelProps = {
    resource: TileRuntimeResource;
    anchorEl: HTMLElement | null;
    onClose: () => void;
};

/** Popover for actionOutput resource tiles. Shows a button for each available action. */
export const ActionOutputPanel: React.FC<ActionOutputPanelProps> = ({
    resource,
    anchorEl,
    onClose,
}) => {
    ...
    const handleAction = (action: string) => {
        sendCommand({ type: "setActionOutput", action });
    };
