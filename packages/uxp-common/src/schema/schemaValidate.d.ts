...
export type AjvKeyword = "type" | "minLength" | "maxLength" | "format" | "minimum" | "maximum" | "pattern" | "enum" | "const" | "required" | "additionalProperties" | "dependencies" | "anyOf" | "allOf" | "oneOf" | "not";
