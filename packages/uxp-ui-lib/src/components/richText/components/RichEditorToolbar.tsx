...
export const RichEditorToolbar: React.FC<ToolbarProps> = ({ editor, portalContainerRef,
    isFullScreen, toggleFullScreen, slotProps, triggerImageUpload }) => {
    ...
    return (
        <div className={`${styles.toolbar}`}>
            ...
            <MultiLevelMenu menuItems={editItems} triggerIcon={<EditIcon />} tooltipText="Edit Actions" container={portalContainerRef.current} />
            <MultiLevelMenu menuItems={addItems} triggerIcon={<AddIcon />} tooltipText="Add Actions" container={portalContainerRef.current} />
