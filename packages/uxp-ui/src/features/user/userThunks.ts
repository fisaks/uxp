...
export const register = createLoadingAwareThunk("user/register", async (payload: RegisterPayload, { rejectWithValue, dispatch }) => {
...
export const unlockUser = createLoadingAwareThunk("user/unlock", async (payload: UnlockUserPayload, { rejectWithValue }) => {
